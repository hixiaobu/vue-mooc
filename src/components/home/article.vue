    ...
    <div class="article-container">
        <div class="article-box">
            ...
            <div class="article-wrap">
                <div class="article-item" :class="item.type=='article'?'blue':'green'" v-for="(item,index) in articleList" :key="index">
                    <!-- 热门话题 -->
                        ...
                        <div class="topic-item"  v-for="(itemtopic,index) in item.data" :key="index">
                            <div class="topic-title">
                                <span class="title green">
                                    #{{itemtopic.topic}}#<br/>{{itemtopic.title}}
                                </span>
                    ...
                    <div v-if="item.type=='article'">
                        ...
                        <div class="bottom-box">                       
                            ...
                            <div class="bottom-info">
                                <span class="bottom-right blue">阅读全文<i class="iconfont icon-arrows-4-7"></i></span>
                    ...
                    <div  v-if="item.type=='question'">
                        ...
                        <div class="bottom-box">                       
                            ...
                            <div class="bottom-info">
                                <span class="bottom-right green">共{{item.total}}个回答<i class="iconfont icon-arrows-4-7"></i></span>
                            </div>
                        </div>
                    </div>                   
                </div>
